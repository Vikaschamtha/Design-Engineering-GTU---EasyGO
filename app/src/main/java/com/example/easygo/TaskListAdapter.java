...
public class TaskListAdapter extends RecyclerView.Adapter<TaskListAdapter.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        private final TextView taskNameTv, taskStatusTv, taskDateTv, taskTimeTv, taskDescriptionTv;
        LinearLayout containerLl;
        ...
        public ViewHolder(View view) {
            ...
            taskTimeTv = view.findViewById(R.id.taskTimeTv);
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int position) {
        ...
        viewHolder.taskNameTv.setText(task.getTaskName());
        viewHolder.taskStatusTv.setText(task.getTaskStatus());
        viewHolder.taskDateTv.setText(task.getTaskDate());
        viewHolder.taskTimeTv.setText(task.getTaskTime());
        viewHolder.taskDescriptionTv.setText(task.getTaskDescription());
